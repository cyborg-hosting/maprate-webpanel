...
define('MR_DBHOST', '[YOUR DB HOST]');
define('MR_DBUSER', '[YOUR DB USERNAME]');
define('MR_DBPASS', '[YOUR DB PASSWORD]');
define('MR_DBNAME', '[YOUR SOURCEMOD DB NAME]');
...
class MapRatings {
    ...
    function __construct() {
        $this->db = mysqli_connect("p:".MR_DBHOST, MR_DBUSER, MR_DBPASS);
        if (!$this->db|| !mysqli_select_db($this->db, MR_DBNAME)) {
